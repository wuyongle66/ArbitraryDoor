...
public class Fragment4 extends Fragment implements View.OnClickListener {
    ...
    private LinearLayout valley;
    private Button valley_personal_center;
    private Button valley_my_mail;
    private Button valley_stress_relaxation;
    private Button valley_Button;
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_valley, container, false);
        valley = (LinearLayout) view.findViewById(R.id.valley);
        valley.setOnClickListener(this);
        Bundle bundle = this.getArguments();//得到从Activity传来的数据
        num = bundle.getString("data");

        valley_personal_center = (Button) view.findViewById(R.id.valley_personal_center);
        valley_personal_center.setOnClickListener(this);
        valley_my_mail = (Button) view.findViewById(R.id.valley_my_mail);
        valley_my_mail.setOnClickListener(this);
        valley_stress_relaxation = (Button) view.findViewById(R.id.valley_stress_relaxation);
        valley_stress_relaxation.setOnClickListener(this);
        valley_Button = (Button) view.findViewById(R.id.valley_button);
        valley_Button.setOnClickListener(this);
        return view;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.valley:
                ...
                ft1.commit();
                break;
            case R.id.valley_personal_center:
                initButton(valley_personal_center);
                ...
                break;
            case R.id.valley_my_mail:
                initButton(valley_my_mail);//按钮震动
                VibrateHelp.vSimple(v.getContext(),VIBRATE_TIME);
                ...
                break;
            case R.id.valley_stress_relaxation:
                initButton(valley_stress_relaxation);//按钮震动
                VibrateHelp.vSimple(v.getContext(),VIBRATE_TIME);
                ...
                enterHome(intent3);
                break;
            case R.id.valley_button:
                initButton(valley_Button);//按钮震动
                VibrateHelp.vSimple(v.getContext(),VIBRATE_TIME);
