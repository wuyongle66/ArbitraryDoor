...
import com.sunnyweather.arbitrarydoor.Calendar.utils.SolarUtil;
...
public class CalendarView extends ViewPager {
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < ta.getIndexCount(); i++) {
            ...
            if (attr == R.styleable.CalendarView_show_last_next) {
                mAttrsBean.setShowLastNext(ta.getBoolean(attr, false));
    ...
    public CalendarView setClockInStatus(HashMap<String, Integer> map) {
        return this;
    }
}
