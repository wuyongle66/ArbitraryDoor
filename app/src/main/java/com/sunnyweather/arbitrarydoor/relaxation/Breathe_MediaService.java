...
public class Breathe_MediaService extends Service {
    ...
    public class MusicController1 extends Binder {
        public void play() {
            mPlayer1.start();//开启音乐
        }
        public void pause() {
        ...
        public long getMusicDuration() {
            return mPlayer1.getDuration();//获取文件的总长度
        }
        public long getPosition() {
            return mPlayer1.getCurrentPosition();//获取当前播放进度
        }
        public void setPosition (int position) {
            mPlayer1.seekTo(position);//重新设定播放进度
        }
    }
    /**
     * 当绑定服务的时候，自动回调这个方法
    ...
    public IBinder onBind(Intent intent) {
        return new MusicController1();
    }
    @Override
    public void onCreate() {
        super.onCreate();
        mPlayer1 = MediaPlayer.create(this, R.raw.breathing_relaxation);
    }
    /**
