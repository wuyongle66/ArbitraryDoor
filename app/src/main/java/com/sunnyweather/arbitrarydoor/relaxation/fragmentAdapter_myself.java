...
public class fragmentAdapter_myself extends FragmentPagerAdapter {
    ...
    public fragmentAdapter_myself(FragmentManager fm, List<Fragment>list_fragment, List<String> list_Title) {
